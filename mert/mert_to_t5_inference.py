...
def infer(t5_model, t5_tokenizer, mert_model, processor, reduce_layer, aggregator, audio_paths, batch_size):
    captions = []
...
def generate_captions(t5_model, t5_tokenizer, mert_model, processor, reduce_layer, aggregator, samples, batch_size):
    ...
    for sample in samples:
        ...
        try:
            inferred_caption = infer(t5_model, t5_tokenizer, mert_model, processor, reduce_layer, aggregator, [audio_path], batch_size)[0][1]
