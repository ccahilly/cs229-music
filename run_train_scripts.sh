...
cd ~/cs229-music/mert
python mert_to_t5_train.py --epochs=1 --last_epoch=1 --frozen=True
...
python mert_to_t5_train.py --epochs=2 --last_epoch=0
...
python wav2vec_to_t5_train.py --epochs=1 --last_epoch=1 --frozen=True
...
python wav2vec_to_t5_train.py --epochs=1 --last_epoch=1
